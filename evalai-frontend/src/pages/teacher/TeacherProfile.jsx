        ...
        <div className="card mb-6" style={{ overflow: "hidden" }}>
          ...
          <div className="profile-body">
            <div className="card card-pad" style={{ marginTop: 0 }}>
              ...
              {editing ? (
                <>
                  {[{ key: "name", label: "Full Name" }, { key: "institution", label: "Institution" }, { key: "email", label: "Email", type: "email" }].map(f => (
                ...
                <div className="grid-2">
                  {[{ label: "Full Name", value: form.name }, { label: "Email", value: form.email }, { label: "Institution", value: form.institution || "—" }, { label: "Role", value: "Teacher" }].map((f, i) => (
                    <div key={i}>
